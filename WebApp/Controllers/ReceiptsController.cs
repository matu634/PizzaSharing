...
namespace WebApp.Controllers
{
    public class ReceiptsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReceiptId,CreatedTime,ReceiptManagerId")] Receipt receipt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReceiptId,CreatedTime,ReceiptManagerId")] Receipt receipt)
        {
